...
const ProductState = (props) => {
  ...
  const handleAddToCart = async (id, num, total) => {
    try {
      setLoading();
      const res = await axios.get(
        `https://backend-ezclothing.herokuapp.com/api/products/${id}?populate=*`
      );
  ...
  const handleAddToCartMen = async (id, num, total) => {
    ...
    try {
      setLoading();
      const res = await axios.get(
        `https://backend-ezclothing.herokuapp.com/api/men/${id}?populate=*`
      );
  ...
  const handleAddToCartBoys = async (id, num, total) => {
    try {
      setLoading();
      const res = await axios.get(
        `https://backend-ezclothing.herokuapp.com/api/boys/${id}?populate=*`
      );
  ...
  const handleAddToCartGirls = async (id, num, total) => {
    ...
    try {
      setLoading();
      const res = await axios.get(
        `https://backend-ezclothing.herokuapp.com/api/girls/${id}?populate=*`
      );
  ...
  const handleAddToCartWomen = async (id, num, total) => {
    ...
    try {
      setLoading();
      const res = await axios.get(
        `https://backend-ezclothing.herokuapp.com/api/women/${id}?populate=*`
      );
